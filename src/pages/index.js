						...
						<div className="row g-xxl-6 g-4 mb-4 justify-content-center">
							<div className="col-lg-4">
								...
								>
									...
									>
										Versatile team player skilled in Analytics, MLOps, and
										Software Development, adeptly offering comprehensive
										expertise across a broad range of diverse and innovative
										technical domains.
									</p>
									<ElementFooterLink
							...
							<div className="col-lg-8">
								...
								<div
									class="col-lg-12 col-md-8 col-sm-6"
									data-aos="fade-down"
									data-aos-duration="1500"
								>
													...
													<ul class="marqee-list d-flex">
														<li class="marquee-item">
															<span class="text-slider">
																<span class="design-tag">UI Design</span>
															</span>
															<span class="text-slider">
																<span class="design-tag">Product Design</span>
															</span>
															<span class="text-slider">
																<span class="design-tag">Workshops</span>
															</span>
															<span class="text-slider">
																<span class="design-tag">Design Sprient</span>
															</span>
															<span class="text-slider">
																<span class="design-tag">Workshops</span>
															</span>{" "}
															...
															<span class="text-slider">
																{" "}
																<span class="design-tag">Mockup Design</span>
															</span>
															<span class="text-slider">
																<span class="design-tag">
																	Interaction Design
											...
											<div class="marquee-inner to-left">
												<ul class="marqee-list d-flex">
													<li class="marquee-item">
														...
														<span class="text-slider">
															<span class="design-tag">Interaction Design</span>
														</span>{" "}
														<span class="text-slider">
															{" "}
															<span class="design-tag">Mockup Design</span>
							...
							>
								...
								>
									...
									<span class="d-flex cmn-footarrow get-respons-1199 align-items-center justify-content-between">
										<span class="fw_500 fs-seven n0-color">Get In Touch</span>
										<svg
											width="58"
											height="40"
											viewBox="0 0 58 40"
						...
						<div className="row g-xxl-6 g-4">
							...
							<div className="col-lg-12 col-md-6 col-sm-6">
								...
								>
									...
									>
										<span class="fw_500 fs-seven n0-color">All Projects</span>
